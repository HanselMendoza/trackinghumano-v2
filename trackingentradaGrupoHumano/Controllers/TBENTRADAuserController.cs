...
namespace trackingentradaGrupoHumano.Controllers
{
    public class TBENTRADAuserController : Controller
    {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "IDENTRADA,IDDEPART,IDOCUPACION,IDMOTIVOENTRADA,CEDULA,NOMBRES,APELLIDOS,FECHAENTRADA,TiempoESTIMADO,TENIACITA,Entro,Localidad,vpresidencial,PISO,COORDENADA,codigoempleado,NombreAnfitrion,HORAENTRADA,HORASALIDA,EstadoSolicitud,telefono")] TBENTRADA tBENTRADA)
        {
            if (ModelState.IsValid)
            {
